...
const OrderHistory_Individual: React.FC = () => {
  ...
  const handleViewDetails = (orderId: string) => {
    navigate(`/individual/track/${orderId}`);
  };
    ...
    <div className="min-h-screen bg-[#EDF4ED] font-sans">
      ...
      <main className="px-8 py-6 max-w-6xl mx-auto">
        ...
        <div className="space-y-6">
          {orders.map((order) => (
            <div key={order.id} className="bg-white rounded-xl p-4 shadow border flex flex-col md:flex-row items-start md:items-center gap-4 hover:shadow-md transition">
